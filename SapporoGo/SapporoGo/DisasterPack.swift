...
class DisasterPack:Pack {
    ...
    init() {
        super.init(name: "災害対策", contents:[
            ...
            ContentsItem(title:"応急給水拠点施設マップ", fileName:"505_防災_給水_調整前", fileType:"csv", purposeType:"MAP", contentsName:"応急給水拠点施設", contentsUrl:"http://www.city.sapporo.jp/suido/riyosya/saigai/torikumi/oukyu/"),
